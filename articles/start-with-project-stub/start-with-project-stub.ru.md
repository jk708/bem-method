...
Альтернативой `ENB` может служить сборщик [bem-tools](http://ru.bem.info/tools/bem/bem-tools/). Результаты сборки и путь к конфигурационным файлам в обоих случаях одинаковы, однако `ENB` работает быстрее и более гибок в настройке.
